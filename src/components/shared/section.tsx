    ...
    <section className={cn('space-y-6', className)} {...props}>
      <div className="flex items-center justify-between gap-4">
        <div className="max-w-[58rem] flex-1 space-y-1">
          ...
          {description ? (
            <p className="max-w-[46rem] text-sm text-balance leading-normal text-muted-foreground sm:text-lg sm:leading-7">
              {description}
            </p>
          ) : null}
        </div>
        ...
        {linkText && (
          <Button variant="outline" className="flex sm:hidden" asChild>
            <Link href={href}>
              {linkText}
