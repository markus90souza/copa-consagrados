export const primeiraRodada = [
  {
    ...
    status: 'Finalizado',
    link: '/partida/fase-01/revoada-x-barcelona-11',
  },

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/fase-01/galacticos-x-morro-da-providencia',
  },

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/fase-01/psg-pituba-x-doces-souza',
  },
...
export const segundaRodada = [
...

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/fase-02/psg-pituba-x-morro-da-providencia',
  },

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/fase-02/galacticos-x-doces-souza',
  },

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/fase-02/biqueira-x-barcelona-11',
  },

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/fase-02/bahia-10-x-revoada',
  },
]
...
export const terceiraRodada = [
...

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/fase-03/milan-x-donos-da-rua',
  },

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/fase-03/bahia-10-x-barcelona-11',
  },
...
export const quartas = [
  {
    ...
    date: 'Terça, 07/01/2025',
    time: '19:30',
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/quartas/doces-souza-x-barcelona-11',
  },

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/quartas/america-x-donos-da-rua',
  },

  {
    ...
    rodada: 'Quartas de Final',
    date: 'Terça, 21/01/2025',
    time: '20:00',
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/quartas/serrado-x-revoada',
  },

  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/quartas/real-madruga-x-galacticos',
  },
]
...
export const semi = [
  {
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/semi/america-x-barcelona',
  },
  {
    time1: {
      name: 'Galácticos',
    ...
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Finalizado',
    link: '/partida/semi/galacticos-x-revoada',
  },
]
...
export const final = [
  {
    ...
    date: 'Sábado, 08/02/2025',
    time: '20:00',
    stadium: 'Quadra Poliesportiva AG 11',
    status: 'Em andamento',
        link: '#'
    // link: '/partida/final/revoada-x-barcelona-11',
  },
  {
    time1: {
      name: 'Galácticos',
    ...
    status: 'Em andamento',
    link: '#'
    // link: '/partida/final/galacticos-x-america',
  },
]
